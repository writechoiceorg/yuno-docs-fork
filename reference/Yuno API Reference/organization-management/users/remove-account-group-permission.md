...
next:
  description: ''
---
This request revokes a user's access to a specific account group by removing the associated permission assignment. The group to be removed is identified by the `account_group_id` in the request path.
